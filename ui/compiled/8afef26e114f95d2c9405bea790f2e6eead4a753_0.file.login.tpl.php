...
/* Smarty version 4.5.3, created on 2026-09-19 14:41:23
  from '/var/www/html/subdomains/adwifi/ui/ui/customer/login.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.3',
  'unifunc' => 'content_6aae9f13761b99_59277759',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '8afef26e114f95d2c9405bea790f2e6eead4a753' => 
    array (
      0 => '/var/www/html/subdomains/adwifi/ui/ui/customer/login.tpl',
      1 => 1789600378,
      2 => 'file',
    ),
  ),
...
function content_6aae9f13761b99_59277759 (Smarty_Internal_Template $_smarty_tpl) {
...
<div class="login-wrapper">
    <div class="login-card">
        ...
        <p class="card-sub"><?php echo Lang::T('Member Login');?>
</p>
...
login/post" method="post" id="loginForm">
...
">
            ...
            <div class="field-group">
                ...
                <div class="field-wrap">
                    <i class="fa fa-<?php if ($_smarty_tpl->tpl_vars['_c']->value['registration_username'] == 'phone') {?>phone<?php } elseif ($_smarty_tpl->tpl_vars['_c']->value['registration_username'] == 'email') {?>envelope<?php } else { ?>user<?php }?> field-icon"></i>
...
echo Lang::T('Username');
            ...
            <!-- Password -->
            <div class="field-group">
                <label class="field-label"><?php echo Lang::T('Password');?>
</label>
                <div class="field-wrap">
                    <i class="fa fa-key field-icon"></i>
                    <input type="password" name="password" class="field-input" 
                        placeholder="<?php echo Lang::T('Enter password');?>
...
register" class="btn btn-success">
                    <i class="fa fa-user-plus"></i> <?php echo Lang::T('Register');?>

                </a>
                <?php }?>
                <button type="submit" class="btn btn-primary">
                    <i class="fa fa-sign-in-alt"></i> <?php echo Lang::T('Login');?>
            ...
            <div class="card-links">
                <a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
forgot"><i class="fa fa-key"></i> <?php echo Lang::T('Forgot Password');?>
</a>
            </div>
        </form>
        ...
        <div class="welcome-section">
            <div class="welcome-title">
                Welcome to<br>
                <span><?php echo $_smarty_tpl->tpl_vars['_c']->value['CompanyName'];?>
</span>
            </div>
            ...
            <?php $_smarty_tpl->_assignInScope('Announcement', ($_smarty_tpl->tpl_vars['PAGES_PATH']->value).("/Announcement.html"));?>
