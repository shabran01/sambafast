...
<form class="form-horizontal">
        ...
        {if $d['user_type'] == "Sales"}<div class="col-sm-6 col-md-6">{else}<div class="col-md-6 col-md-offset-3">{/if}
                <div
                    ...
                    <div class="panel-footer">
                        <center>
                            {if $admin['user_type'] neq 'Viewer'}
                                <a href="{$_url}settings/users-edit/{$d['id']}" class="btn btn-info btn-block">{Lang::T('Edit')}</a>
                            {/if}
    ...
    <div class="form-group text-center">
        {if $admin['user_type'] neq 'Viewer'}
            <a href="{$_url}settings/users-edit/{$d['id']}" class="btn btn-primary">{Lang::T('Edit')}</a>
        {/if}
        <a href="{$_url}settings/users">{Lang::T('Back')}</a>
    </div>
</form>
