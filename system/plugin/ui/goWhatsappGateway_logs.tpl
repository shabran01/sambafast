...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-list-alt"></i> GoWhatsApp Message Logs</h3>
    </div>
    <div class="panel-body">
        <div class="row" style="margin-bottom: 15px;">
            <div class="col-md-8">
                <form method="get" action="{$_url}plugin/gowhatsapp_logs" class="form-inline">
            ...
            <div class="col-md-4 text-right">
                <a href="{$_url}plugin/gowhatsapp" class="btn btn-default"><i class="fa fa-arrow-left"></i> Back</a>
            ...
            <ul class="pagination">
                {for $i=1 to $totalPages}
                    <li {if $i == $page}class="active"{/if}>
                        <a href="{$_url}plugin/gowhatsapp_logs&page={$i}&search={$search}">{$i}</a>
                    </li>
                {/for}
            </ul>
        </div>
