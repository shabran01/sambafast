...
$htmlContent .= "                    <!-- Price intentionally NOT shown to customers. The amount is resolved\n";
$htmlContent .= "                         server-side from the plan, so nothing here needs it. -->\n";
...
$htmlContent .= "    // Prices are intentionally not shown to customers, and the amount is resolved\n";
$htmlContent .= "    // server-side from the plan, so no price is passed in or displayed here.\n";
$htmlContent .= "    var msg = 'Enter your Mpesa number below and click <strong>Pay Now</strong> to initialize the payment';\n";
