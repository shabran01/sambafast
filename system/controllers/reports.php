...
switch ($action) {
    ...
    case 'activation':
        ...
        if ($q != '') {
            ...
            switch ($search_type) {
                case 'username':
                    $query->where_like('username', '%' . $q . '%');
                    break;
                case 'method':
                    $query->where_like('method', '%' . $q . '%');
                    break;
                case 'invoice':
                default:
            ...
            $d = Paginator::findMany($query, ['q' => $q, 'search_type' => $search_type]);
        } else {
        ...
        $ui->assign('q', $q);
        $ui->assign('search_type', $search_type);
