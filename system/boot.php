...
$_detected_url = 'https://' . (isset($_SERVER['HTTP_HOST']) ? $_SERVER['HTTP_HOST'] : parse_url(APP_URL, PHP_URL_HOST));
$ui->assign('_detected_url', $_detected_url);
...
try {
    ...
    $ui->assign("error_title", "SpeedRadius Crash");
