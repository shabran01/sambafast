...
if (!isTableExist('tbl_plans')) {
    ORM::raw_execute("CREATE TABLE IF NOT EXISTS tbl_plans (
...
if (!isTableExist('tbl_pool')) {
    ORM::raw_execute("CREATE TABLE IF NOT EXISTS tbl_pool (
        id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
if (!isTableExist('tbl_bandwidth')) {
    ORM::raw_execute("CREATE TABLE IF NOT EXISTS tbl_bandwidth (
        id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
        name_bw VARCHAR(255) NOT NULL,
        rate_down VARCHAR(50),
        rate_up VARCHAR(50),
        created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
        updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8;");
...
if (!isTableExist('tbl_routers')) {
    ORM::raw_execute("CREATE TABLE IF NOT EXISTS tbl_routers (
        id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
